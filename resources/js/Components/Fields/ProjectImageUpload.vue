...
const startUpload = () => {
  ...
  router.post(`/member/listings/${props.businessId}/projects/${props.projectId}/images`, formData, {
    preserveScroll: true,
    onSuccess: () => {
      files.value = []
      closeModal()
...
const deleteImage = (imageId) => {
  ...
  router.delete(`/member/listings/${props.businessId}/projects/${props.projectId}/images/${imageId}`, {
    preserveScroll: true,
    onSuccess: () => {
      emit('updated')
    },
