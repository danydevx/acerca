<template>
  <div class="property-gallery-upload">
    <div class="d-flex justify-content-between align-items-center mb-2">
      ...
      <button type="button" class="btn btn-primary rounded-pill btn-sm" @click="openModal">
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body p-4">
              ...
              <div v-else class="upload-preview">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  ...
                  <button type="button" class="btn btn-secondary rounded-pill btn-sm" @click="clearFiles">
                ...
                <div class="upload-preview__grid">
                  <div v-for="(file, index) in files" :key="index" class="upload-preview__item">
                    ...
                    <button type="button" class="btn btn-danger rounded-pill btn-sm upload-preview__remove" @click="removeFile(index)">
                      <i class="bi bi-x"></i>
                    </button>
                  </div>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary rounded-pill" data-bs-dismiss="modal" :disabled="uploading">
                Cancelar
              </button>
              <button v-if="!uploading && files.length > 0" type="button" class="btn btn-primary rounded-pill" @click="startUpload">
...
const startUpload = () => {
  ...
  router.post(`/member/listings/${props.businessId}/properties/${props.propertyId}/images`, formData, {
    preserveScroll: true,
    onSuccess: () => {
      files.value = []
      closeModal()
...
const deleteImage = (imageId) => {
  ...
  router.delete(`/member/listings/${props.businessId}/properties/${props.propertyId}/images/${imageId}`, {
    preserveScroll: true,
    onSuccess: () => {
      emit('updated')
    },
