<template>
  <MemberLayout>
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
      ...
      <Link href="/pricing" class="btn btn-secondary rounded-pill">Volver a planes</Link>
    </div>
          ...
          <div class="card-body">
            ...
            <div class="border-top pt-3 mt-3">
              ...
              <div v-if="coupon" class="d-flex flex-wrap align-items-center justify-content-between">
                ...
                <button type="button" class="btn btn-secondary rounded-pill btn-sm" @click="clearCoupon">
                  Quitar
                </button>
              </div>
              <form v-else class="d-flex flex-wrap gap-2" @submit.prevent="applyCoupon">
                ...
                />
                <button type="submit" class="btn btn-info rounded-pill" :disabled="processingCoupon">
                  Aplicar
                </button>
              </form>
