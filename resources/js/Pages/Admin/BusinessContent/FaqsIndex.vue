  ...
  <AdminLayout>
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
      ...
      <div class="d-flex gap-2">
        <Link :href="`/admin/listings/${listing.id}/faq-categories`" class="btn btn-secondary btn-sm">
          ...
          <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
              ...
              <tr v-for="faq in faqs.data" :key="faq.id">
                ...
                <td class="text-end">
                  <Link :href="`/admin/listings/${listing.id}/faqs/${faq.id}/edit`" class="btn btn-sm btn-info">
                    Editar
                  </Link>
                </td>
              </tr>
