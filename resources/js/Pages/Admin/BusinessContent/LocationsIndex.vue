  ...
  <AdminLayout>
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
      <div>
        ...
        <h1 class="h4 mb-1 mt-1">{{ listing.name }} - Ubicaciones</h1>
      </div>
      <Link :href="`/admin/listings/${listing.id}/locations/create`" class="btn btn-primary btn-sm">
          ...
          <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
              ...
              <tr v-for="loc in locations.data" :key="loc.id">
                ...
                <td class="text-end">
                  <Link :href="`/admin/listings/${listing.id}/locations/${loc.id}/edit`" class="btn btn-sm btn-info">
                    Editar
                  </Link>
                </td>
              </tr>
