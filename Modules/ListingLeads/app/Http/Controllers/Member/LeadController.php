...
namespace Modules\ListingLeads\Http\Controllers\Member;
...
class LeadController extends Controller
{
    public function index(Request $request, Listing $business)
    {
        ...
        $query = ListingLead::forListing($business->id)
            ->with('location')
    ...
    public function export(Request $request, Listing $business)
    {
        ...
        $leads = ListingLead::forListing($business->id)
            ->with('location')
    ...
    public function bulkDelete(Request $request, Listing $business)
    {
        ...
        ListingLead::forListing($business->id)
            ->whereIn('id', $data['ids'])
            ->delete();
