...
namespace Modules\ListingReviews\Http\Controllers\Member;
...
class ReviewController extends Controller
{
    public function index(Request $request, Listing $business)
    {
        ...
        $query = ListingReview::forListing($business->id)
            ->with('location')
    ...
    public function bulkDelete(Request $request, Listing $business)
    {
        ...
        ListingReview::forListing($business->id)
            ->whereIn('id', $data['ids'])
            ->delete();
    ...
    public function clone(Request $request, Listing $business, ListingReview $review, ActivityService $activity)
    {
        ...
        $maxOrder = ListingReview::forListing($business->id)->max('sort_order') ?? 0;

        $cloned = ListingReview::create([
