...
namespace Modules\ListingPromotions\Http\Controllers\Member;
...
class PromotionController extends Controller
{
    public function index(Request $request, Listing $business)
    {
        ...
        $query = ListingPromotion::forListing($business->id)
            ->with('location')
    ...
    public function store(Request $request, Listing $business, ActivityService $activity)
    {
        ...
        $promotion = ListingPromotion::create($data);
    ...
    public function clone(Request $request, Listing $business, ListingPromotion $promotion, ActivityService $activity)
    {
        ...
        $maxOrder = ListingPromotion::forListing($business->id)->max('sort_order') ?? 0;

        $cloned = ListingPromotion::create([
