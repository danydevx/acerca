...
namespace Modules\ListingContactForm\Http\Controllers\Member;
...
class ContactFormController extends Controller
{
    public function index(Request $request, Listing $business)
    {
        ...
        $query = ListingContactForm::where('listing_id', $business->id)
            ->withCount('fields')
    ...
    public function create(Request $request, Listing $business)
    {
        ...
        $maxForms = $this->getMaxFormsPerBusiness();
        $currentCount = ListingContactForm::where('listing_id', $business->id)->count();
    ...
    public function store(Request $request, Listing $business)
    {
        ...
        $form = ListingContactForm::create(array_merge($validated, ['listing_id' => $business->id]));

        if ($validated['is_active'] ?? false) {
            ListingContactForm::where('listing_id', $business->id)->where('id', '!=', $form->id)->update(['is_active' => false]);
        }
    ...
    public function submissions(Request $request, Listing $business, ListingContactForm $form)
    {
        ...
        $query = ListingLead::where('listing_id', $business->id)
