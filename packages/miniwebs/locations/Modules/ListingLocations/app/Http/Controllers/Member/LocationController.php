...
namespace Modules\ListingLocations\Http\Controllers\Member;
...
class LocationController extends Controller
{
    public function index(Request $request, Listing $business)
    {
        ...
        $query = ListingLocation::where('listing_id', $business->id)
    ...
    public function store(Request $request, Listing $business, ActivityService $activity)
    {
        ...
        $location = ListingLocation::create($data);

        if (isset($data['is_primary']) && $data['is_primary']) {
            ListingLocation::where('listing_id', $business->id)->where('id', '!=', $location->id)->update(['is_primary' => false]);
        }
    ...
    {
        $this->authorize('deleteAny', [ListingLocation::class, $business]);
        ...
        $count = ListingLocation::where('listing_id', $business->id)
