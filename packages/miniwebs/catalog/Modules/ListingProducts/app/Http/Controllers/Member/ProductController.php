...
namespace Modules\ListingProducts\Http\Controllers\Member;
...
class ProductController extends Controller
{
    public function index(Request $request, Listing $business)
    {
        ...
        $query = ListingProduct::forListing($business->id)
        ...
        $categories = ListingProductCategory::forListing($business->id)
            ->where('is_active', true)
            ->orderBy('name')
            ->get(['id', 'name']);
    ...
    public function create(Request $request, Listing $business)
    {
        ...
        $locations = ListingLocation::where('listing_id', $business->id)->where('is_active', true)->orderBy('name')->get(['id', 'name']);
        $categories = ListingProductCategory::forListing($business->id)->where('is_active', true)->orderBy('name')->get(['id', 'name']);
    ...
    public function store(Request $request, Listing $business, ActivityService $activity)
    {
        ...
        $product = ListingProduct::create($data);
