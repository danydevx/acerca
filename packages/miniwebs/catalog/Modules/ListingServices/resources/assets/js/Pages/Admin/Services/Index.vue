  ...
  <AdminLayout>
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
      <div>
        ...
        <h1 class="h4 mb-1 mt-1">{{ listing.name }} - Servicios</h1>
      </div>
      <div class="d-flex gap-2">
        <Link :href="`/admin/listings/${listing.id}/service-categories`" class="btn btn-secondary btn-sm">
          <i class="bi bi-folder me-1"></i>
          Categorias
        </Link>
        <Link :href="`/admin/listings/${listing.id}/services/create`" class="btn btn-primary btn-sm">
          ...
          <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
              ...
              <tr v-for="svc in services.data" :key="svc.id">
                ...
                <td class="text-end">
                  <Link :href="`/admin/listings/${listing.id}/services/${svc.id}/edit`" class="btn btn-sm btn-info">
                    Editar
                  </Link>
                </td>
              </tr>
