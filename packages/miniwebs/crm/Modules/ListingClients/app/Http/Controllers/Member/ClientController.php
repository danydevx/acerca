...
namespace Modules\ListingClients\Http\Controllers\Member;
...
class ClientController extends Controller
{
    public function index(Request $request, Listing $business)
    {
        ...
        $query = ListingClient::where('listing_id', $business->id)
    ...
    public function store(Request $request, Listing $business, ActivityService $activity)
    {
        ...
        $client = ListingClient::create(array_merge($data, ['listing_id' => $business->id]));
    ...
    public function clone(Request $request, Listing $business, ListingClient $client, ActivityService $activity)
    {
        ...
        $clonedClient = ListingClient::create(array_merge([
